                    ...
                    <form role="form" action="{{URL::to('/save-category-product')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            data-validation="required"
                                data-validation-error-msg=" Vui lòng nhập tên danh mục "
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="8"
                                class="form-control" 
                                data-validation="required"
                                data-validation-error-msg=" Vui lòng nhập mô tả danh mục "
                                name="category_product_desc" id="exampleInputPassword1" placeholder="Mô tả danh mục" >
                            </textarea>
                        </div>
                        <div class="form-group">
