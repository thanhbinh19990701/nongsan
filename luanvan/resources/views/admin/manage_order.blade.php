...
{{--                        <td><label class="i-checks m-b-none"><input type="checkbox" name="post[]"><i></i></label></td>--}}
                        ...
                        <td><span class="text-ellipsis">
                                ...
                                <a href="{{URL::to('/unactive-order/'.$order->order_id)}}">
                                    <span style="font-size: 12px" class="fa fa-pencil-square-o text-success text-active">Check đơn hàng</span>
                                </a>
                                <?php
                                    }else{
                                    ?>
                               {{--  <a href="{{URL::to('/active-order/'.$order->order_id)}}">
                                    <span style="font-size: 12px" class="fa-thums-styling fa fa-thumbs-down">hủy đơn</span>
                                </a> --}}
                                <?php
                                    }
                                    ?>
